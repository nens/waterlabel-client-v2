            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="394.33" height="528" viewBox="0 0 394.33 528">
                <g id="Group_26" data-name="Group 26" transform="translate(-10072 -414)">
                  ...
                  <text id="G" transform="translate(10082 929)" fill="#fff" stroke="#fff" stroke-width="1" font-size="30" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">G</tspan></text>
                  <text id="F" transform="translate(10082 869)" fill="#fff" stroke="#fff" stroke-width="1" font-size="30" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">F</tspan></text>
                  <text id="E" transform="translate(10082 809)" fill="#fff" stroke="#fff" stroke-width="1" font-size="30" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">E</tspan></text>
                  <text id="D" transform="translate(10082 749)" fill="#fff" stroke="#fff" stroke-width="1" font-size="30" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">D</tspan></text>
                  <text id="C" transform="translate(10082 689)" fill="#fff" stroke="#fff" stroke-width="1" font-size="30" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">C</tspan></text>
                  <text id="B" transform="translate(10082 629)" fill="#fff" stroke="#fff" stroke-width="1" font-size="30" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">B</tspan></text>
                  <text id="A" transform="translate(10082 569)" fill="#fff" stroke="#fff" stroke-width="1" font-size="30" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">A</tspan></text>
                  <text id="A_" data-name="A+" transform="translate(10082 509)" fill="#fff" stroke="#fff" stroke-width="1" font-size="30" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">A+</tspan></text>
                  <text id="A_2" data-name="A++" transform="translate(10082 449)" fill="#fff" stroke="#fff" stroke-width="1" font-size="30" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">A++</tspan></text>
                  ...
                  <g id="Group_25" data-name="Group 25" transform={`translate(10063 ${waterLabelArrowYCoordinate})`}>
                    <line id="Line_5" data-name="Line 5" x2="60.43" transform="translate(342.9 515.533)" fill="none" stroke="#707070" stroke-width="5"/>
